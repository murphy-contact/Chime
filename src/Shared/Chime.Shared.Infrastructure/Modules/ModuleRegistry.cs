...
internal sealed class ModuleRegistry : IModuleRegistry
{
    ...
    {
        if (string.IsNullOrWhiteSpace(requestType.Namespace)) throw new InvalidOperationException("Missing namespace.");
    ...
    {
        if (path is null) throw new InvalidOperationException("Request path cannot be null.");
